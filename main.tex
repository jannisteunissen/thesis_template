...
% If you want to use "import" for your chapters (to have relative includes of
% figures or other content), enable this line, and replace \input{directory/file} by
...
% This command can be used to make sure new start on the right page
