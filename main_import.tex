% Thesis template, using import commands for the chapters. If you want to use
% simple "input" for your chapters have a look at main_input.tex
...
% Make sure this package is available (or simply put it in the current folder)
\usepackage{import}
...
\import{./chapters/}{frontmatter.tex}
...
\import{./chapters/}{chapter_1_import.tex}
\tclear

\import{./chapters/}{chapter_2.tex}
\tclear
